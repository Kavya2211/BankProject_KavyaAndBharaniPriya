...
public class LoanApproval extends User_Details implements loan{
	...
	@Override
	public int checkLoanAmt(double loan_amt) {
	...
	@Override
	public int checkBalance(double amt, int choice) {
	...
	public static void main(String[] args) {
		...
		if(la.checkLoanAmt(udetails.loan_amt)==0){
			...
			case 1:{
				...
				if(la.checkBalance(udetails.balance,choice)==1){
					System.out.println("Loan NOT Approved since Balance less than 10 lakhs !!!");
				}
				else{
					udetails.emi = la.calculateEmi(udetails.loan_amt,6,5);
			...
			case 2:{
				...
				if(la.checkBalance(udetails.balance,choice)==1){
					...
					udetails.emi = la.calculateEmi(udetails.loan_amt,8,6);
			...
			case 3:{
				udetails.emi = la.calculateEmi(udetails.loan_amt,5,1);
		...
		System.out.println("Fname,Lname,Phone,Address,Balance,Loan_Amount,Approval,TypeOfLoan,EMI");
